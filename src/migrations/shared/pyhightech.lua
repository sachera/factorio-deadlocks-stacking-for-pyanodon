return {
  ...
  { item = "electronic-circuit", icon = nil, iconName = "circuit-board-1", stage = 1 },

  { item = "advanced-circuit", icon = nil, iconName = "circuit-board-2", stage = 2 },
  ...
  { item = "processor", iconName = "circuit-board-3", icon = nil, stage = 3 },
